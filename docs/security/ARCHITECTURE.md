...
## 13. Backup / Restauration — Format et Chiffrement

### 13.1 Structure du fichier de backup
...
### 13.2 Processus de création du backup
...
### 13.3 Processus de restauration
...
## 14. Transfert P2P — Protocole Cryptographique Complet

### 14.1 Découverte des pairs
...
### 14.2 Handshake — Établissement de la session chiffrée
...
### 14.3 Session chiffrée — Messages individuels
...
### 14.4 Re-chiffrement en transit (zero-disk plaintext)
...
### 14.5 Re-chiffrement des fichiers en transit
...
## 15. Trust Store — Stockage de Confiance entre Appareils

### 15.1 Dérivation de la sous-clé trust store
...
### 15.5 ML-KEM-768 — Détails de l'implémentation
...
## 16. Session & Auto-lock — Gestion des Tokens
...
### 16.2 Ce qui se passe au lock/logout
...
## 17. Gestion des Secrets en Mémoire

### 17.1 Types sécurisés
...
### 17.2 SecureKey — Fonctionnement détaillé
...
## 18. Gestion des Erreurs Cryptographiques
