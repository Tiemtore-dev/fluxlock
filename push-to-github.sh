...
if git remote | grep -q "origin"; then
    ...
    read -p "Entrez l'URL de votre dépôt GitHub (ex: https://github.com/Tiemtore-dev/secure-vault-next-gen.git): " REPO_URL
...
echo "1. Visitez https://github.com/Tiemtore-dev/secure-vault-next-gen"
