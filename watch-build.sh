...
echo "   https://github.com/Tiemtore-dev/secure-vault-next-gen/actions/runs/$RUN_ID"
echo ""
...
if gh run view $RUN_ID --json conclusion --jq '.conclusion' | grep -q "success"; then
    ...
    echo "   https://github.com/Tiemtore-dev/secure-vault-next-gen/releases/tag/v2.0.0"
fi
